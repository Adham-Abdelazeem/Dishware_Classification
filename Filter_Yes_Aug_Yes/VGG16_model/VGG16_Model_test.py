...
model = tf.keras.models.load_model(r"D:\Master\M.L & A.I\Tasks\Task 8\models\Filter_No_Aug_Yes\VGG16_model\vgg16.hdf5")

data_path_test = r"D:\Master\M.L & A.I\Tasks\Task 8\Filter_No_Aug_Yes\valid"
img_height = 255
img_width = 255
